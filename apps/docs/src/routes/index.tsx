      ...
      <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-14">
        <div className="lg:sticky lg:top-24 lg:self-start">
          ...
          <p className="text-muted mb-6 leading-relaxed">
            Each run is an event log you can replay, subscribe to, and extend with your own domain modules.
          </p>
          ...
          <p className="text-muted mb-6 leading-relaxed">
            ...
            through deterministic reducers and request effects. <strong>Projections</strong> fold
            this stream into real-time reactive UI state and indexes.
          </p>
