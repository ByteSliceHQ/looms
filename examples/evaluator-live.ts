...
// Hosted TypeSafe Jev through vercelEvaluator(). Needs AI_GATEWAY_API_KEY.
// Swap `model` for another evaluation model that speaks the same question API.
// bun run --filter @looms/examples evaluator-live
